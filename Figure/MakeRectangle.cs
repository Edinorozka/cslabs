...
{
    [Serializable()]
    internal class MakeRectangle : Figure
    {
        public MakeRectangle(Point point1, Point point2, Color color, Color Cbackground, int lineWidth) : base(point1, point2, color, Cbackground, lineWidth) { }

        public override void Draw(Graphics g)  // метод рисования прямоугольника по полученным точкам
        {
        ...
        public override void DrawDash(Graphics g) // метод рисования примера создаваемой фигуры
        {
